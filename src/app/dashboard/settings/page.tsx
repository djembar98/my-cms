...
export default function SecuritySettingsPage() {
  ...
  async function updateEmail() {
    ...
    setNewEmail("");
    alert("Email update diminta ✅ Cek inbox email baru untuk verifikasi.");
  }
      ...
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <div className={cx("text-sm", subtleText)}>
            Ubah email/password dan kelola session.
          </div>
        </div>
        ...
        <>
          ...
          <div className="rounded-3xl border border-white/20 bg-white/40 p-5 dark:border-white/10 dark:bg-white/5">
            ...
            <div className="mt-4 space-y-3">
              ...
              <div className={cx("text-xs", subtleText)}>
                Setelah update, cek inbox email baru untuk link verifikasi Supabase.
              </div>
            </div>
          </div>
          ...
          <div className="rounded-3xl border border-white/20 bg-white/40 p-5 dark:border-white/10 dark:bg-white/5">
            <div className="flex items-center gap-2">
              ...
              <div className="text-sm font-semibold tracking-tight">Session</div>
            </div>
